...
@WebServlet(value = "/admin/updateRoom")
@MultipartConfig
public class UpdateRoomController extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		RequestDispatcher rd = req.getRequestDispatcher("/views/admin/updateRoom.jsp");
		rd.forward(req, resp);
	}
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String imghidden = req.getParameter("imghidden");
		int id = Integer.valueOf(req.getParameter("id"));
		
		Room room = new Room(id, nameRoom, price, imghidden, 1, typeRoom, des);
