            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Các loại Phòng</h1>
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="updateType?id=${list.id}">sửa</a></td>
                                            <td><a href="deleteType?id=${list.id}">xóa</a></td>
                                            <td><a href="trang-chu?id=${list.id}">ds phòng</a></td>
                                        </tr>
                                        </c:forEach>
                                    </tbody>
                                </table>
