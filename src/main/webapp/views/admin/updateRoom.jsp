            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid addroom">
                        <h1 class="mt-4">Cập nhật phòng</h1>
                        <div class="row">
                        <form method="post" action="updateRoom" enctype="multipart/form-data">
                            <div class="col-md-8">
                                <label>Tên phòng:</label>
                                <input type="text" name="roomName" value="${room.name}" class="form-control">
                                ...
                                <textarea id="editor" name="des">${room.description}</textarea>

                                <div class="tm-product-img-dummy mx-auto">
                                  <p><i class="fas fa-cloud-upload-alt tm-upload-icon"></i>Chọn ảnh phòng</p>
                                </div>
                                <img class="img_updateType" src="${room.image}">
                                <input type="hidden" name="imghidden" value="${room.image}">
