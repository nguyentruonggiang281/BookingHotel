            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid addroom">
                        <h1 class="mt-4">Cập nhật loại phòng</h1>
                        <div class="row">
                        <form method="post" action="updateType" enctype="multipart/form-data">
                            <div class="col-md-8">
                                <label>Tên loại phòng:</label>
                                <input type="text" name="roomName" class="form-control" value="${typeRoom.name}">

                                <div class="tm-product-img-dummy mx-auto">
                                  <p><i class="fas fa-cloud-upload-alt tm-upload-icon"></i>Chọn ảnh</p>
                                </div>
                                <img class="img_updateType" src="${typeRoom.image}">
                                <input type="file" class="form-control" name="file">
                                <input type="hidden" name="imghidden" value="${typeRoom.image}">
                                <input type="hidden" name="id" value="${typeRoom.id}">
                                <input type="submit" value="cập nhật" class="form-control" style="margin-top: 30px;">
                            </div>
                        </form>
                        </div>
                    </div>
